...
|----------|---------------|-------------|------|-------|-------------|
| Week 1   | Contract, setup, schema, upload and original storage   |  Application starts; database and upload foundation work  | 9/9/2026 | No | Make a disclaimer for naccepted image |
| Week 2   | | | | |  |
